...
import com.gaidukev.busybeetimer.databinding.FragmentOptionSelectionScreenBinding;

/**
 * An example full-screen activity that shows and hides the system UI (i.e.
 * status bar and navigation/system bar) with user interaction.
 */
public class OptionSelectionScreen extends Fragment {
    /**
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentOptionSelectionScreenBinding.inflate(inflater, container, false);
